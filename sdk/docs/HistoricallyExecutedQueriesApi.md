# finbourne_luminesce.HistoricallyExecutedQueriesApi
...
async with api_client_factory:
    ...
    api_instance = api_client_factory.build(finbourne_luminesce.HistoricallyExecutedQueriesApi)
    ...
    try:
        ...
        print("The response of HistoricallyExecutedQueriesApi->cancel_history:\n")
        pprint(api_response)
...
async with api_client_factory:
    ...
    try:
        ...
        print("The response of HistoricallyExecutedQueriesApi->fetch_history_result_histogram:\n")
        pprint(api_response)
    except Exception as e:
...
async with api_client_factory:
    ...
    try:
        ...
        print("The response of HistoricallyExecutedQueriesApi->fetch_history_result_json:\n")
        pprint(api_response)
    except Exception as e:
...
async with api_client_factory:
    ...
    try:
        # GetHistory: Shows queries executed in a given historical time window (in Json format).
        api_response = await api_instance.get_history(start_at=start_at, end_at=end_at, free_text_search=free_text_search, show_all=show_all)
        print("The response of HistoricallyExecutedQueriesApi->get_history:\n")
        pprint(api_response)
    except Exception as e:
...
async with api_client_factory:
    ...
    try:
        ...
        print("The response of HistoricallyExecutedQueriesApi->get_progress_of_history:\n")
        pprint(api_response)
    except Exception as e:
