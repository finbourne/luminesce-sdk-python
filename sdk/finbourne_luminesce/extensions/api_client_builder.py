...
from finbourne_luminesce.api_client import ApiClient as AsyncApiClient
...
from finbourne_luminesce.configuration import Configuration
import finbourne_luminesce.extensions.retry as retry
from finbourne_luminesce.extensions.socket_keep_alive import keep_alive_socket_options
from finbourne_luminesce.extensions.tcp_keep_alive_connector import TcpKeepAliveConnector
import os
...
def build_client(
    ...
    try:
        ...
        # Set the proxy for finbourne_luminesce if needed
