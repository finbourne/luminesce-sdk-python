...
from luminesce.api_client import ApiClient as AsyncApiClient
...
import luminesce.extensions.retry as retry
from luminesce.extensions.socket_keep_alive import keep_alive_socket_options
from luminesce.extensions.tcp_keep_alive_connector import TcpKeepAliveConnector
import os
...
def build_client(
    ...
    try:
        ...
        # Set the proxy for luminesce if needed
